...
PHOTON_ROUTER_IP=192.168.30.3
PHOTON_ROUTER_GW=192.168.30.2
PHOTON_ROUTER_DNS=192.168.30.2
SETUP_DNS_SERVER=1
...
if [ ${SETUP_DNS_SERVER} -eq 1 ]; then
    ...
    local-data: "router.tanzu.local A 192.168.30.3"
    local-data-ptr: "192.168.30.3 router.tanzu.local"
